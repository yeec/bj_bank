...
class Lovepay extends React.Component {
    ...
    componentWillMount(){
        ...
        setTimeout(() => {
            ...
            for (var i = 0; i < baoxianlist.length; i++) {//用第一组list作参照
                ...
                for (var j = 0; j < baoxianlist2.length; j++) {//循环第二组找到对应的值
                    if(baoxianlist[i].CodeProductBusi == baoxianlist2[j].CodeProductBusi){
                        // alert(baoxianlist[i].CodeProductBusi)
                ...
                for (var x = 0; x < baoxianlist4.length; x++) {//循环第三组找到对应的值
                    if(baoxianlist[i].CodeProductBusi == baoxianlist4[x].CodeProductBusi){
                        // alert(baoxianlist[i].CodeProductBusi)
    ...
    render() {
        return (
            <div className="rit-dfgz">
               <Swiperye lunbolist={this.state.lunbolist} imgsrcguding={this.state.imgsrcguding}/>
                <div className="rit-circular-menu-hight"></div>
                <div className="rit-circular-menu-box">

                    <div className="rit-circular-menu" onClick={this.gotoEwpPage.bind(this,"gongzichaxun")}>
                        <div className="rit-circular-gongzi"></div>
                        <div className="rit-circular-title">工资查询</div>
                        <div className="rit-circular-ms">秒查工资明细</div>
                    </div>
                    <div className="rit-circular-menu" onClick={this.gotoEwpPage.bind(this,"yibaofuwu")}>
                        <div className="rit-circular-yibao"></div>
                        <div className="rit-circular-title">医保服务</div>
                        <div className="rit-circular-ms">到账转入工资卡</div>
                    </div>
                    <div className="rit-circular-menu" onClick={this.gotoEwpPage.bind(this,"lingqulipin")}>
                        <div className="rit-circular-lipin"></div>
                ...
                <div className="bj-card-list" onClick={this.gotoEwpPage.bind(this,"licaigoumai")}>
            {/*.rit-li-card-buttom-cp-left-bafenb  百分比的样式*/
            }
                    <Card title={"远见薪满益足DTG01170302"} data={this.state.riskLevelName} lastBenchmark={this.state.lastBenchmark} lastBenchmarkdian={this.state.lastBenchmarkdian}/>
                </div>
                <div className="ryt-higth"></div>
                <div className="ryt-jxb-dhy">
                    <div className="ryt-jxb-dhy-left"  onClick={this.gotoEwpPage.bind(this,"jingxibao")}>
                        <div className="ryt-jxb-dhy-left-bf-jingxibao"></div>
                    ...
                    <div className="ryt-jxb-dhy-boder"></div>
                    <div className="ryt-jxb-dhy-left"  onClick={this.gotoEwpPage.bind(this,"dinghuiying")}>
                        <div className="ryt-jxb-dhy-left-bf-dinghuiying"></div>
                        <div className="ryt-jxb-dhy-left-bf-tex">
                ...
                <div className="bj-card-list" onClick={this.gotoEwpPage.bind(this,"xiaofeidai")}>
                ...
                <div className="rit-lc">
                    ...
                    <div className="rit-lc-xbz-card img" onClick={this.gotoEwpPage.bind(this,"xinbaozhang")}>
                        <div className="rit-lc-xbz-card-bg">
                            <img className="ryt-jiankuang-baoxian-imgss" src={this.state.imgbaoxian}/>

                        </div>
                        <div className="rit-lc-xbz-card-list">
                            <div className="rit-lc-xbz-card-list-li">
                                <div className="rit-lc-xbz-card-list-li-top">{this.state.startPrem}元</div>
                                <div className="rit-lc-xbz-card-list-li-buttom">最低投保保额</div>
                            </div>
                            <div className="rit-lc-xbz-card-list-li">
                                <div className="rit-lc-xbz-card-list-li-top-black">{this.state.appAge}</div>
                                <div className="rit-lc-xbz-card-list-li-buttom">投保年龄</div>
                            </div>
                            <div className="rit-lc-xbz-card-list-li" style={{borderRight:"none"}}>
                                <div className="rit-lc-xbz-card-list-li-top-black">{this.state.age}</div>
                    ...
                    <div className="rit-lc-box">
                        ...
                        <div className="rit-lc-titile-aixinka">
                            <div className="rit-lc-titile-aixinka-box">
                                ...
                                <div className="rit-lc-titile-aixinka-box-right"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="rit-lc">
                    ...
                    <div className="xanquan">
                        <div className="xanquan-box">
                            <div className="xanquan-box-left" onClick={this.gotoEwpPage.bind(this,"duanxintianshi")}>
                                <div className="xanquan-box-left-bg left"></div>
                                <div className="xanquan-box-left-text">
                                    <div className="xanquan-box-left-text-title">短信天使</div>
                                    <div className="xanquan-box-left-text-tixing">工资到账 免费提醒</div>
                                </div>
                            </div>
                            <div className="xanquan-box-left" onClick={this.gotoEwpPage.bind(this,"atmpos")}>
                                <div className="xanquan-box-left-bg right"></div>
                                <div className="xanquan-box-left-text">
                                    <div className="xanquan-box-left-text-title">ATM/POS管理</div>
                                    <div className="xanquan-box-left-text-tixing">取钱消费 限额设置</div>
                                </div>
                            </div>
                        </div>
                    </div>
