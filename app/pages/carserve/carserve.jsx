...
class Carserve extends React.Component {
  ...
  gotoWHPage = jyType => {
    ...
    if (jyType === "qichefuwu") {
      service =
        "https://open.chediandian.com/member/login?ApiKey=b9cbf6a267d1ddad23d366a239fdd600&ApiSt=1530752867&ApiSign=6d85032115e5b35984d3c26ca8eaf287&ReturnUrl=http%3A%2F%2Ft.cn%2FRdyuJpJ&openid=";
      ewpType = "beidongdenglu";
    }
    //汽车保险
    if (jyType === "qichebaoxian") {
      var service =
        "https://open.chediandian.com/member/login?ApiKey=b9cbf6a267d1ddad23d366a239fdd600&ApiSt=1530752867&ApiSign=6d85032115e5b35984d3c26ca8eaf287&ReturnUrl=http%3A%2F%2Fins.chediandian.com%2Fhome%2Fh5ul%2F%3Frefcode%3Dbjbank&openid=";
      ewpType = "beidongdenglu";
    }
    //汽车贷款
    ...
    if (jyType === "meirongyanghu") {
      service =
        "https://open.chediandian.com/member/login?ApiKey=b9cbf6a267d1ddad23d366a239fdd600&ApiSt=1530752867&ApiSign=6d85032115e5b35984d3c26ca8eaf287&ReturnUrl=http%3A%2F%2Ft.cn%2FRDEJ0zz&openid=";
      ewpType = "beidongdenglu";
    }
    //到店保养
    if (jyType === "daodianbaoyang") {
      service =
        "https://open.chediandian.com/member/login?ApiKey=b9cbf6a267d1ddad23d366a239fdd600&ApiSt=1530752867&ApiSign=6d85032115e5b35984d3c26ca8eaf287&ReturnUrl=http%3A%2F%2Ft.cn%2FRdy3Pcw&openid=";
      ewpType = "beidongdenglu";
    }
    //道路救援
    if (jyType === "daolujiuyuan") {
      service =
        "https://open.chediandian.com/member/login?ApiKey=b9cbf6a267d1ddad23d366a239fdd600&ApiSt=1530752867&ApiSign=6d85032115e5b35984d3c26ca8eaf287&ReturnUrl=http%3A%2F%2Ft.cn%2FRdymjqW&openid=";
      ewpType = "beidongdenglu";
    }
    //违章查询
    if (jyType === "weizhangchaxun") {
      service =
        "https://open.chediandian.com/member/login?ApiKey=b9cbf6a267d1ddad23d366a239fdd600&ApiSt=1530752867&ApiSign=6d85032115e5b35984d3c26ca8eaf287&ReturnUrl=http%3A%2F%2Fopen.chediandian.com%2FTrafficViolation%2FIndex&openid=";
      ewpType = "beidongdenglu";
    }
    //加油卡充值--ewp
    ...
    return (
      <div>
        <div className="rit-qichefuwu">
          <div className="rit-qichefuwu-banner qiche" />
          <div className="rit-qichefuwu-box">
            <MenuCard
              fage="1"
              click1={this.gotoWHPage.bind(this, "qichefuwu")}
          ...
          <div className="rit-qichefuwu-list">
            <List
              onClicks={this.gotoWHPage.bind(this, "jiayouzhan")}
              text="加油站查询"
            />
            <List
              onClicks={this.gotoWHPage.bind(this, "tingchechang")}
              text="停车场查询"
            />
            <List
              onClicks={this.gotoWHPage.bind(this, "4sdian")}
              text="4S店查询"
            />
          </div>
        </div>
