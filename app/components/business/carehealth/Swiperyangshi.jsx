...
class Swiperyangshi extends React.Component{
                ...
                onClick: function(swiper,e){
                    ...
                    if(swiperlunbolist.length > 1){
                        if(swiper.activeIndex == 0){
                            var itemString = JSON.stringify(swiperlunbolist[swiperlunbolist.length - 1]).replace(/\"/g,"'");
                            ...
                            var itemString = JSON.stringify(swiperlunbolist[0]).replace(/\"/g,"'");
                            bjdevice.doEMPFunction("lunboClick","",itemString);
    ...
    render () {
        ...
        swiperlunbo = swiperlunbolist.map(function(item,key){
            ...
            // .swiper-pagination
            return(
                <div key={key} className="swiper-slide" onClick={me.onClick.bind(me,item)}>
                    <img className="img-lunbo" src={me.props.imgsrcguding + "/" + item.HPImage}/>
                </div>
            )
        })
        return (
