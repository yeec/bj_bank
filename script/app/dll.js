...
const config = require("./config/webpack.conf.dll");
...
// 首先，读取构建目录中的当前文件大小。
// 这让我们可以显示以后改变了多少。
measureFileSizesBeforeBuild(paths.appDll)
  ...
  .then(
    ({
      ...
      console.log(color.yellow("公共资源文件清单:"));
...
function build(previousFileSizes) {
  ...
  console.log(color.cyan("☺ 公共资源打包中, 请稍后 ♪♪♪"));
